...
# Create age categories and filter rows
...
# Create hours per day categories and filter rows
...
# Filter data for only Yes and No values in the Instrumentalist column
...
# Finish the density plot for anxiety distribution by instrumentalist status
...
# Create the box plot for anxiety by hours listening to music per day
